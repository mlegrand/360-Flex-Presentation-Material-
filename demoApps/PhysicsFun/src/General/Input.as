...
package General{
	...
	public class Input{
		...
		public function Input(stage:Stage){
			...
			stage.addEventListener(MouseEvent.CLICK, mouseRelease, false, 0, true);
			...
			stage.addEventListener(TouchEvent.TOUCH_BEGIN, touchPress, false, 0, true);
			stage.addEventListener(TouchEvent.TOUCH_END, touchRelease, false, 0, true);
			stage.addEventListener(TouchEvent.TOUCH_MOVE, touchMove, false, 0, true);
	...
	/*		if (mouseDown != e.buttonDown){
			...
			*/
			mouseX = e.localX - m_stageMc.x;
			mouseY = e.localY - m_stageMc.y;
			// Store offset
			mouseOffsetX = mouseX - mouse.x;
			mouseOffsetY = mouseY - mouse.y;
			// Update drag
