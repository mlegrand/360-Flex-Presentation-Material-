package components
{
	...
	public class RotatableScalable
	{
		...
		private function onTouchBegin( event : TouchEvent ) : void
		{
			...
			pointMap[ event.touchPointID.toString() ] = new Point(event.stageX, event.stageY);
			addBlob( event.touchPointID, event.stageX, event.stageY );
		}
		...
		private function onTouchMove( event : TouchEvent ) : void
		{
			...
			{
				pointMap[ event.touchPointID.toString() ].x = event.stageX;
				pointMap[ event.touchPointID.toString() ].y = event.stageY;
			}
			update(null)
		}
